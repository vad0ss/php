...
<a href="<?php echo $this->item->category->link; ?>">Московская недвижимость</a>
...
<?php endif; ?>
<?php if($this->item->extraFields->metro->value != ''): ?>
<li>
...
<span class="catItemExtraFieldsValuePrice"><?php echo $this->item->extraFields->price->value; ?> р.</span>
</li>
<?php endif; ?>
</ul>
<div class="clr"></div>

...
<a href="<?php echo $this->item->category->link; ?>">Зарубежная недвижимость</a>
...
<?php endif; ?>
<?php if($this->item->extraFields->distanceSea->value != ''): ?>
<li>
...
<span class="catItemExtraFieldsValuePrice"><?php echo $this->item->extraFields->price->value; ?> EUR</span>
</li>
<?php endif; ?>
</ul>
<div class="clr"></div>
